...
export const exampleRoutes = [
  ...
  {
    path: '/practical/list-with-transitions',
  ...
  {
    path: '/gui/flight-booker',
    component: () => import('@/examples/gui/flight-booker/FlightBooker.vue'),
    meta: { category: 'Gui', title: 'Flight Booker' },
  },
  {
    path: '/gui/elapsed-timer',
  ...
  {
    path: '/gui/cells',
    component: () => import('@/examples/gui/cells/Cells.vue'),
    meta: { category: 'Gui', title: 'Cells' },
  },
